...
const Analytics: React.FC = () => {
  ...
  const getMonthlyData = () => {
    ...
    expenses.forEach(expense => {
      const monthKey = new Date(expense.date).toLocaleDateString('en-US', { month: 'short', year: 'numeric' });
      if (monthlyData[monthKey]) {
    ...
    patients.forEach(patient => {
      const monthKey = new Date(patient.createdAt).toLocaleDateString('en-US', { month: 'short', year: 'numeric' });
      if (monthlyData[monthKey]) {
    ...
    reports.forEach(report => {
      const monthKey = new Date(report.createdAt).toLocaleDateString('en-US', { month: 'short', year: 'numeric' });
      if (monthlyData[monthKey]) {
